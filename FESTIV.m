...
if strcmp(use_Default_RTSCUC,'YES')
    ...
    wgdx(['TEMP', filesep, 'RTSCUCINPUT1'],PTDF,BLOCK_COST,BLOCK_CAP,QSC,GEN_EFFICIENCY_BLOCK,GEN_EFFICIENCY_MW,PUMP_EFFICIENCY_BLOCK,PUMP_EFFICIENCY_MW,...
        ...
        GENEFFICIENCYVALUE,PUMPUP_PERIOD,PUMPDOWN_PERIOD,GEN,BUS,GENPARAM,RESERVEPARAM,BRANCHPARAM,COSTCURVEPARAM,BRANCH,RESERVETYPE,...
        LOAD_DIST,BRANCHDATA,RESERVEVALUE,COST_CURVE,SYSTEMVALUE,SYSPARAM,STORAGEPARAM,...
        INITIAL_DISPATCH_SLACK_SET,LODF,PTDF_PAR,STARTUP_PERIOD,SHUTDOWN_PERIOD,PARTICIPATION_FACTORS,GENBUS2,BRANCHBUS2);
...
if strcmp(use_Default_RTSCED,'YES')
    ...
    wgdx(['TEMP', filesep, 'RTSCEDINPUT1'],PTDF,BRANCHDATA,PARTICIPATION_FACTORS,STORAGEPARAM,GEN,BUS,GENPARAM,RESERVEPARAM,...
        ...
        QSC,BLOCK_CAP,BLOCK_COST,BIND_INTERVAL_1,LOAD_DIST,RESERVEVALUE,COST_CURVE,SYSTEMVALUE,SYSPARAM,INITIAL_DISPATCH_SLACK_SET);
        ...
        if nvcr > 0
            ...
            while(t <= size_RTD_VG_FULL )
                ...
                if(time/24 - RTD_VG_FULL(t,1) >= 0 && time/24 - RTD_VG_FULL(t+HRTD,1) < 0)
                    ...
                    vg_forecast_tmp(1:HRPU,:) = ones(HRPU,1)*(RPU_data_create_weighting.*max(0,ACTUAL_VG_FULL(AGC_interval_index-round(PRPU*60/t_AGC)-1,2:end)) ...
       ...
       for i=1:ngen
        ...
        if strcmp(use_Default_SCRPU,'YES')
            ...
            [RPUPRODCOST,RPUGENSCHEDULE,RPULMP,RPUUNITSTATUS,RPUUNITSTARTUP,RPUUNITSHUTDOWN,RPUGENRESERVESCHEDULE,...
                ...
                = getgamsdata('TOTAL_RTSCUCOUTPUT','RPU','YES',GEN,INTERVAL,BUS,BRANCH,RESERVETYPE,RESERVEPARAM,GENPARAM,STORAGEPARAM,BRANCHPARAM);
        end
        try

function [BUS_DELIVERY_FACTORS_VAL,GEN_DELIVERY_FACTORS_VAL,LOAD_DELIVERY_FACTORS_VAL]=calculateDeliveryFactors(H,nbus,ngen,GEN_NAME,BRANCHBUS,PTDF_VAL,LINEFLOWS,systemMVA,branch_resistances,PARTICIPATION_FACTOR_NAMES,GENBUS_VALS,BUS_VAL,PARTICIPATION_FACTORS_VAL,LOAD_VAL,LOAD_STRING)
...
for t=1:H
    for i=1:ngen
        i2=1;
        while i2<=ngen
            if strcmp(PARTICIPATION_FACTOR_GEN_NAMES(1,i),GEN_NAME(1,i2))
                gen_indice = i2;
                i2=ngen;
            end;
            i2=i2+1;

...
if useHDF5==0
    for d = 1:simulation_days
        ACTUAL_LOAD_FULL_TMP = xlsread(cell2mat(actual_load_input_file(d,1)),'A1:B30000');
        ...
        if nvg > 0
            [ACTUAL_VG_FULL_TMP, ACTUAL_VG_FIELD] = xlsread(cell2mat(actual_vg_input_file(d,1)));

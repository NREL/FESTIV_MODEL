function [rtc_num, rtc_text] = make_rtd_cs(mo,month,date1, irtc, prtc)
% make SCUC and SCED files. Command line example:
%  for date=24:30 ; [~,~]=make_rtd_cs(7,'July',date, 60, 5) ; end
%%definitions:
   ...
   %mo = 7;  month = 'July'; date1 = 24; % these are f-n inputs
    xl = '.xls'; csv = '.csv';
     vg_prefx = 'APS_wind_SC2_'; % needs mo/date to build the file name
      rtc_prefx = 'RTD1_APS_VG_forecast_'; rtc_suffx = '_at60min'; % needs mo/date...

...
wgdx(['TEMP', filesep, 'RTSCUCINPUT2'],LAST_STARTUP,LAST_SHUTDOWN,PUCOST_BLOCK_OFFSET,LOSS_BIAS,INTERVAL_MINUTES,...
...
if rtscuc_running 
    ...
    = getgamsdata('TOTAL_RTSCUCOUTPUT','RTSCUC','YES',GEN,INTERVAL,BUS,BRANCH,RESERVETYPE,SYSTEMVALUE_VAL,RESERVEVALUE_VAL,GENPARAM,STORAGEVALUE,BRANCHPARAM);
elseif rpu_running
    ...
    = getgamsdata('TOTAL_RTSCUCOUTPUT','RPU','YES',GEN,INTERVAL,BUS,BRANCH,RESERVETYPE,SYSTEMVALUE_VAL,RESERVEVALUE_VAL,GENPARAM,STORAGEVALUE,BRANCHPARAM);
end;
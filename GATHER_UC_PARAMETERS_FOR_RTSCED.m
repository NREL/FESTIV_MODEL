    ...
    if Solving_Initial_Models==0 && rtd_gen_forced_out(i,1) == 1
       ...
       UNIT_PUMPUPMINGENHELP_VAL(find(storage_to_gen_index==i),1) = 0;
        ...
        for t=1:HRTD
            ...
            [UNIT_STARTINGUP_VAL(i,t),UNIT_STARTUPMINGENHELP_VAL(i,t),UNIT_SHUTTINGDOWN_VAL(i,t)]=RTSCED_SUSD_Trajectories(STATUS(:,1+i),UNIT_STATUS_VAL(i,t),GENVALUE_VAL(i,gen_type),GENVALUE_VAL(i,:),ACTUAL_START_TIME(i,1),LAST_GEN_SCHEDULE_VAL(i,1),RTD_LOOKAHEAD_INTERVAL_VAL,INTERVAL_MINUTES_VAL,rtscuc_I_perhour,eps,su_time,sd_time,min_gen,initial_status,t,time,IDAC);
...
for e=1:nESR
        [UNIT_PUMPINGUP_VAL(e,t),UNIT_PUMPUPMINGENHELP_VAL(e,t),UNIT_PUMPINGDOWN_VAL(e,t)]=RTSCED_SUSD_Trajectories(PUMPSTATUS(:,1+storage_to_gen_index(e,1)),PUMPING_VAL(e,t),GENVALUE_VAL(storage_to_gen_index(e,1),gen_type),STORAGEVALUE_VAL(e,:),ACTUAL_PUMPUP_TIME(e,1),LAST_PUMP_SCHEDULE_VAL(e,1),RTD_LOOKAHEAD_INTERVAL_VAL,INTERVAL_MINUTES_VAL,rtscuc_I_perhour,eps,pump_su_time,pump_sd_time,min_pump,initial_pump_status,t,time,IDAC);
end;

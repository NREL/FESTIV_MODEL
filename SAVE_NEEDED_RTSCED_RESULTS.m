...
RTD_LF(RTSCED_binding_interval_index,:)=LINEFLOWS(:,1)';
if lossesCheck > eps
    RTSCEDMARGINALLOSS(RTSCED_binding_interval_index,1)=RTD_LOOKAHEAD_INTERVAL_VAL(1,1);
    RTSCEDMARGINALLOSS(RTSCED_binding_interval_index,2) = marginalLoss(1,1);
